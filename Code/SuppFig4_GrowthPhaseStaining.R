...
ordered_names <- c("C. neogracile", "P. subcurvata", "F. cylindrus", "Chaetoceros sp 02", "Chaetoceros sp 12", "Odontella sp", "Chaetoceros sp 22", "O. rostrata", "G. huxleyi", "G. oceanica", "Tetraselmis sp.", "T. chui", "Chlamydomonas sp.", "M. antarctica", "P. tychotreta", "G. cryophila")
...
# Save plot
ggsave("Figures/SuppFig4.tiff", plot = graph, width = 8, height = 8, units = "in", dpi = 300)
