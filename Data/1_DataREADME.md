...
*Tab: CytPix*
- Name - Species name
- Type - Taxonomic class of the organism
- Metabolism - best prediction of metabolism (Phototroph or Mixotroph)
- Cytometer - flow cytometer used to collect the measurment
- DateTracker - date of LysoTracker measurement
- DateSensor - date of LysoSensor measurement
- Tracker - percent of cells stained with LysoTracker. Average of technical replicates
- sdTracker - standard deviation of technical replicates for percent of cells stained with LysoTracker
- Sensor - percent of cells stained with LysoSensor. Average of technical replicates
...
- Cytometer - flow cytometer used to collect the measurment
- DateTracker - date of LysoTracker measurement
- avTracker - percent of cells stained with LysoTracker. Average of technical replicates
- sdTracker - standard deviation of technical replicates for percent of cells stained with LysoTracker
- CellConcentration - concentration of cells (cells/mL) during staining
- ln - natural log of the cell concentration
...
22.[CultureFLP](https://github.com/CohenLabUGA/AcidotropicDyes/blob/main/Data/CultureFLP.xlsx)

*Tab: FLP*
- Culture - name of species 
- Replicate - Biological replicate (A,B or C)
- CSGR - cell specific grazing rate (bacteria / (cell* hour))

*Tab: FLP_toplot*
- Name - name of species
- Type - Taxonomic class of the organism
- Metabolism - Autotroph or mixotroph
- AvGrazing - cell specific grazing rate (bacteria / (cell* hour)) average of 3 biological replicates
- SdGrazing - cell specific grazing rate (bacteria / (cell* hour)) standard deviation of 3 biological replicates

*Tab: Raw_FLP*
- DateCounted - date that the slide was counted under the microscope
- Culture - name of species
- Timepoint - samples taken immediately after surrogate prey spike are T0. Samples taken after 1 hour of incubation are T1
- Replicate - Biological replicate (A, B, or C)
- RedCells - count of cells containing chlorophyll
- RedwithBead - count of cells containing chlorophyll that also ingested a prey
- NumBeads - count of prey ingested
- Squares - number of fields of view counted
- Objective - magnification objective used to count cells
- Percent - percent of eating cells
- subpercent - T1-T0 of Percent for each replicate
- IR - ingestion rate, or uptake rate, of beads
- subIR - T1-T0 of IR
- avpercent - average percent of eating cells across 3 biological replicates
- sdpercent - standard deviation of the percent of eating cells across 3 biological replicates
- bacteria - average bacteria concentration from the 3 replicates
- CSGR - cell specific grazing rate (bacteria / (cell * hr))
- avCSGR - mean of the CSGR for the 3 biological replicates
- sdCSGR - standard deviation of the CSGR for 3 biological replicates
